'''
Define an HPVsim simulation for Kenya
'''
...
def run_sims(parsets=None, debug=False, verbose=-1, analyzers=None, save_results=True, **kwargs):
    ...
    msim.reduce()
    if save_results:
        sc.saveobj(f'msim_kenya.obj', msim.results)
...
if __name__ == '__main__':
    ...
    calib_pars = sc.loadobj('hpvsim_kenya/kenya_pars_nov07.obj')  # Load some parameters from a previous calibration
